...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, InterfaceOnRecyclerViewItemClick {
    ...
    @Override
    public void onSetAlarmBtnClick(Note note, int position) {
    ...
    protected Dialog createdDialog(int id) {
        switch (id) {
            case TIME_DIALOG_ID:
                return new TimePickerDialog(this, timePickerListener, Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MONDAY), false);
        }
        return null;
    }
    ...
    private TimePickerDialog.OnTimeSetListener timePickerListener = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minutes) {
            ...
            intent.putExtra(AlarmClock.EXTRA_MESSAGE, noteList.get(position).getNote());
